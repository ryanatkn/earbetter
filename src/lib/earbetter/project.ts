...
export type Project_Id = Flavored<z.infer<typeof Project_Id>, 'Project_Id'>; // TODO @many this doesn't work when used as a schema, use z.brand() instead? or are the egonomics too bad?
export const create_project_id = (): Project_Id => to_random_id();

export const Project_Name = z.string().min(1).max(1000);
export type Project_Name = Flavored<z.infer<typeof Project_Name>, 'Project_Name'>; // TODO @many this doesn't work when used as a schema, use z.brand() instead? or are the egonomics too bad?
