		...
		realms: [
			...
			},
			{
				...
				levels: [
					// TODO maybe arrange these by difficulty?
					{
						name: 'minor second vs minor third',
						intervals: [1, 3],
						sequence_length: 2,
					},
					{
					...
					{
						name: 'one octave',
						intervals: to_scale_notes(lookup_scale('Phrygian'), 1),
						sequence_length: 2,
					},
					{
						name: 'two octaves',
						intervals: to_scale_notes(lookup_scale('Phrygian'), 2),
						sequence_length: 2,
					},
					{
						name: 'four octaves',
						intervals: to_scale_notes(lookup_scale('Phrygian'), 4),
						sequence_length: 2,
					},
					{
						name: 'one octave (4 notes)',
			...
			},
			{
				...
				levels: [
					...
					{
						name: 'major third vs diminished fifth/augmented fourth',
						intervals: [4, 6],
						sequence_length: 2,
					},
					{
						name: 'diminished fifth/augmented fourth vs perfect fifth',
						intervals: [6, 7],
						sequence_length: 2,
					},
					{
					...
					{
						name: 'one octave',
						intervals: lookup_scale('Lydian').notes,
						sequence_length: 2,
					},
					{
						name: 'two octaves',
						intervals: to_scale_notes(lookup_scale('Lydian'), 2),
						sequence_length: 2,
					},
					{
						name: 'four octaves',
						intervals: to_scale_notes(lookup_scale('Lydian'), 4),
						sequence_length: 2,
					},
					{
						name: 'one octave (4 notes)',
			...
			},
			{
				...
				levels: [
					...
					{
						name: 'perfect fourth vs diminished fifth/augmented fourth',
						intervals: [5, 6],
						sequence_length: 2,
					},
					{
						name: 'diminished fifth/augmented fourth vs minor sixth',
						intervals: [6, 8],
						sequence_length: 2,
					},
					{
					...
					{
						name: 'one octave',
						intervals: to_scale_notes(lookup_scale('Locrian'), 1),
						sequence_length: 2,
					},
					{
						name: 'two octaves',
						intervals: to_scale_notes(lookup_scale('Locrian'), 2),
						sequence_length: 2,
					},
					{
						name: 'four octaves',
						intervals: to_scale_notes(lookup_scale('Locrian'), 4),
						sequence_length: 2,
					},
					{
						name: 'one octave (4 notes)',
